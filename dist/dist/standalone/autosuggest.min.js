              ...
              },
              {
                ...
                value: function (e, t, n) {
                  var o = this.props.inputProps,
                    r = o.value,
                    i = o.onChange;
                  (t === r && 'type' === n) || i(e, { newValue: t, method: n });
                },
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  var e = this,
                    ...
                    I = h ? me : this.props.shouldRenderSuggestions,
                    w = s.value,
                    j = s.onFocus,
                    P = s.onKeyDown,
                    x = this.willRenderSuggestions(this.props, 'render'),
                    _ = h || (m && !v && x),
                    C = _ ? n : [],
                    k = ae({}, s, {
                      onFocus: function (t) {
                      ...
                      onKeyDown: function (t, o) {
                        ...
                        switch (r) {
                          ...
                          case 13:
                            ...
                            if ((_ && !h && e.closeSuggestions(), null != a)) {
                              var l = p(a);
